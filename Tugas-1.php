<?php
	...
	if (($tanggal >= 23 && $tanggal <= 31 && $bulan== 7 ) || ($tanggal >= 1 && $tanggal <= 22 && $bulan== 8)) {
		$hasil = "LEO";
	}
	...
	if (($tanggal >= 22 && $tanggal <= 30 && $bulan== 11 ) || ($tanggal >= 1 && $tanggal <= 21 && $bulan== 12)) {
		$hasil = "SAGITARIUS";
	}
	
	if (($tanggal >= 22 && $tanggal <= 31 && $bulan== 12 ) || ($tanggal >= 1 && $tanggal <= 19 && $bulan== 1)) {
		$hasil = "CAPRICORN";
	}
